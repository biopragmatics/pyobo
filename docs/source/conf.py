...
# of the sidebar.
#
# html_logo = 'PyOBO-square-100.png'
...
latex_documents = [
    (master_doc, "PyOBO.tex", "PyOBO Documentation", "Charles Tapley Hoyt", "manual"),
]
...
man_pages = [(master_doc, "pyobo", "PyOBO Documentation", [author], 1)]
...
if os.environ.get("READTHEDOCS", None):
    tags.add("readthedocs")  # noqa:F821
