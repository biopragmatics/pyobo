...
has_obo_namespace = Reference(prefix="oboInOwl", identifier="hasOBONamespace", name="has OBO namespace")
obo_autogenerated_by = Reference(prefix="oboInOwl", identifier="auto-generated-by", name="auto-generated by")
